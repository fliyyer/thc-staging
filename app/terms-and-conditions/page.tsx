...
import termsHeroImage from "@/assets/hero-terms.webp";
        ...
        <div className="mx-auto flex w-full max-w-360 flex-1 items-end px-4 pb-10 pt-8 sm:px-10 sm:pb-16 lg:pb-20 2xl:px-0">
          <div className="max-w-5xl">
            ...
            <p className="max-w-4xl text-sm sm:text-lg lg:text-xl font-medium mt-3 sm:mt-4">
              Please take a moment to review the terms, policies, and conditions
              that govern your access to and use of True High Collabs.
            </p>
          </div>
        </div>
      </div>
    ...
    <section className="px-6 py-28 sm:px-10 lg:py-36">
      <article className="mx-auto max-w-7xl">
        <header className="text-center">
          ...
          <h2 className="mt-4 text-[22px] font-satoshi font-bold tracking-normal sm:text-5xl">
            Term &amp; Conditions
          </h2>
        ...
        <div className="mt-10 sm:mt-16 space-y-8 text-sm sm:text-lg text-justify sm:leading-6">
          <TermsSection title="Overview">
            <p>
              This website is operated by truehighcollabs. Throughout the site,
              the terms “we”, “us” and “our” refer to truehighcollabs.
              truehighcollabs offers this website, including all information,
          ...
          <TermsSection title="General Conditions">
            <p>
          ...
          <TermsSection title="Accuracy, Completeness and Timeliness of Information">
            <p>
              We am not responsible if information made available on this site
          ...
          <TermsSection title="Modifications to the Service">
          ...
          <TermsSection title="Accuracy of Billing and Account Information">
            <p>
          ...
          <TermsSection title="Optional Tools">
            <p>
          ...
          <TermsSection title="User Comments, Feedback, and Other Submissions">
            <p>
          ...
          <TermsSection title="Personal Information">
            <p>
          ...
          <TermsSection title="Errors, Inaccuracies and Omissions">
            <p>
          ...
          <TermsSection title="Disclaimer of Warranties, Limitation of Liability">
            <p>
            ...
            <p>
              In no case shall truehighcollabs, our directors, officers,
          ...
          <TermsSection title="Indemnification">
            <p>
              You agree to indemnify, defend and hold harmless truehighcollabs
          ...
          <TermsSection title="Entire Agreement">
            <p>
          ...
          <TermsSection title="Changes to Terms and Conditions">
            <p>
